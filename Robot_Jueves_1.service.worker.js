...
const CACHE_NAME = "Robot_Jueves_1-cache";
const OFFLINE_URL = "Robot_Jueves_1.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Robot_Jueves_1.html","Robot_Jueves_1.js","Robot_Jueves_1.wasm","Robot_Jueves_1.pck","Robot_Jueves_1.offline.html","Robot_Jueves_1.icon.png","Robot_Jueves_1.apple-touch-icon.png"];
